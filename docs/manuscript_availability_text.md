...
Metabolomics repository wording should be updated only after the Zenodo record has been re-checked.

## Response Letter Wording

We have added the public GitHub repository URL for the analysis code and linked the sequencing data to the direct NCBI BioProject page.
